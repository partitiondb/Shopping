...
where dbid in (db_id('BayMartGate'),db_id('DowneyDB'),db_id('OrangeDB'),db_id('PanoramaDB'),db_id('BayMartGlobalDB'),db_id('BayMartCommonDB'),db_id('BayMartLogDB'),db_id('BayMartSourceDB')) and cmd = 'AWAITING COMMAND' and spid <> @@spid;
exec(@sql);
end;
go
...
if db_id('BayMartCommonDB') is not null drop database BayMartCommonDB;
...
go
use BayMartGate;
exec PdbcreatePartition 'BayMartGate','BayMartCommonDB',@DatabaseTypeId=2;
...
exec PdbcreatePartition 'BayMartGate','BayMartLogDB',@DatabaseTypeId=4,@StandAloneSchemaName='Log';

exec PdbsyncSourceTable 'BayMartGate','dbo','Companies'		,'BayMartSourceDB',@IsUpdate=0,@IsDelete=0,@SyncInterval=1;
exec PdbsyncSourceTable 'BayMartGate','dbo','Stores'		,'BayMartSourceDB',@Columns='Id,Name,RowVersion',@IsUpdate=0,@IsDelete=0,@SyncInterval=1;
exec PdbsyncSourceTable 'BayMartGate','dbo','Manufacturers'	,'BayMartSourceDB',@Columns='Id,Name,RowVersion',@IsUpdate=0,@IsDelete=0,@SyncInterval=1;
exec PdbsyncSourceTable 'BayMartGate','dbo','Categories'	,'BayMartSourceDB',@Columns='Id,Name,RowVersion',@IsDelete=0,@SyncInterval=1;
exec PdbsyncSourceTable 'BayMartGate','dbo','Catalogs'		,'BayMartSourceDB',@Columns='Id,Name,RowVersion',@IsDelete=0,@SyncInterval=1;
exec PdbsyncSourceTable 'BayMartGate','dbo','Products'		,'BayMartSourceDB',@Columns='Id,Name,CatalogNumber,CatalogId,ManufacturerId,RowVersion',@SyncInterval=1;
...
exec PdbsyncSourceTable 'BayMartGate','dbo','ShoppingLog'	,'BayMartSourceDB',@TargetSchemaName='Log',@TargetTableName='Shopping',@IsUpdate=0,@IsDelete=0,@SyncInterval=1;
...
exec PdbsyncSourceTable 'BayMartGate','dbo','Companies'		,'BayMartSourceDB',@IsUpdate=0,@IsDelete=0,@SyncInterval=1440;
exec PdbsyncSourceTable 'BayMartGate','dbo','Stores'		,'BayMartSourceDB',@IsUpdate=0,@IsDelete=0,@SyncInterval=1440;
exec PdbsyncSourceTable 'BayMartGate','dbo','Manufacturers'	,'BayMartSourceDB',@IsUpdate=0,@IsDelete=0,@SyncInterval=60;
exec PdbsyncSourceTable 'BayMartGate','dbo','Categories'	,'BayMartSourceDB',@Columns='Id,Name,RowVersion',@IsDelete=0,@SyncInterval=60;
exec PdbsyncSourceTable 'BayMartGate','dbo','Catalogs'		,'BayMartSourceDB',@Columns='Id,Name,RowVersion',@IsDelete=0,@SyncInterval=60;
exec PdbsyncSourceTable 'BayMartGate','dbo','Products'		,'BayMartSourceDB',@Columns='Id,Name,CatalogNumber,CatalogId,ManufacturerId,RowVersion',@SyncInterval=60;
...
exec PdbsyncSourceTable 'BayMartGate','dbo','Items'			,'BayMartSourceDB',@SyncInterval=1; -- Default @IsUpdate=1 @IsDelete=1
exec PdbsyncSourceTable 'BayMartGate','dbo','ShoppingLog'	,'BayMartSourceDB',@TargetSchemaName='Log',@TargetTableName='Shopping',@IsUpdate=0,@IsDelete=0,@SyncInterval=120;
