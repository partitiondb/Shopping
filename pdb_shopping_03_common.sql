...
where dbid in (db_id('BayMartGate'),db_id('DowneyDB'),db_id('OrangeDB'),db_id('PanoramaDB'),db_id('BayMartGlobalDB'),db_id('BayMartCommonDB'),db_id('BayMartSourceDB')) and cmd = 'AWAITING COMMAND' and spid <> @@spid;
exec(@sql);
end;
go
